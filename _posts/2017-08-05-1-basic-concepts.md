...
给定任意两个人都决定去宾馆的概率为0.0001，入住同一宾馆的概率为0.0001/10^5，那么，在任意给定的两个不同日子，两人入住同一宾馆的概率为$10^{-18}$。

为简化运算，对于较大n，$\binom{n}{k}$约等于$n^2/2$。$10^9$人组队个数$\binom{10^9}{2}=5x10^{17}$，而1000天内任意两天的组合数$\binom{1000}{2}=5x10^5$。疑似坏人的期望为 $5x10^{27} \times 5 \times 10^5 x 10^(-18) = 250000$，即月25万对人员看上去像坏人。
